function SignUpForm(event){
    ...
    {
        document.getElementById("email_msg").innerHTML="Email is empty or invalid(example: aaaa@uregina.ca)";
        result = false;
    }
