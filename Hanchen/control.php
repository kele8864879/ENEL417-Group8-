...
<?php
	...
	if (isset($_POST["save"]) && $_POST["save"])
	{
        ...
        if($validate == true)
        {
		    ...
		    $q2 = "INSERT INTO control_set (client_id, temperater_set, light_set, humidity_set, Date_Set_Time, heater_set, fans_set, pump_set, lifting_set) VALUES ('$userid', '$tempurature', '$light', '$humidity', '$dateFormat', '0', '0', '0', '0')";
		    $r2 = $db->query($q2);
